    ...
    for (var m2 = 0, b2 = 0, v2 = 0, n2 = 0, q2, g2, x2 = 0, K2 = 0, k2, u2 = k2 = q2 = 0, l2 = 0, r2 = 0, I2 = 0, t2 = 0, B3 = e2.length, J2 = B3 - 1, y2, f2 = "", p = "", F3 = "", G3 = "", C2; l2 < B3; ) {
      ...
      if (0 === b2 + n2 + v2 + m2) {
        ...
        switch (g2) {
          ...
          case 59:
            ...
            if (1 < (t2 = f2.length))
              switch (0 === u2 && (q2 = f2.charCodeAt(0), 45 === q2 || 96 < q2 && 123 > q2) && (t2 = (f2 = f2.replace(" ", ":")).length), 0 < A2 && void 0 !== (C2 = H2(1, f2, c2, d2, D2, z2, p.length, h, a2, h)) && 0 === (t2 = (f2 = C2.trim()).length) && (f2 = "\0\0"), q2 = f2.charCodeAt(0), g2 = f2.charCodeAt(1), q2) {
                case 0:
                  break;
                case 64:
                  if (105 === g2 || 99 === g2) {
      ...
      switch (g2) {
        ...
        case 10:
          ...
          0 < A2 * Y2 && H2(0, f2, c2, d2, D2, z2, p.length, h, a2, h);
          z2 = 1;
          D2++;
          break;
        case 59:
...
function Ye(e2, t2, n2) {
  ...
  var A2, C2 = new oe(n2, v2, o2 ? e2.componentStyle : void 0), I2 = C2.isStatic && 0 === c2.length, P2 = function(e3, t3) {
    return function(e4, t4, n3, r2) {
      ...
      }(i3, r2, m2, true ? e4.warnTooManyClasses : void 0), S2 = n3, b2 = v6.$as || t4.$as || v6.as || t4.as || h2, _2 = xe(b2), N3 = v6 !== t4 ? y({}, t4, {}, v6) : t4, A3 = {};
      for (var C3 in N3)
        "$" !== C3[0] && "as" !== C3 && ("forwardedAs" === C3 ? A3.as = N3[C3] : (l3 ? l3(C3, isPropValid, b2) : !_2 || isPropValid(C3)) && (A3[C3] = N3[C3]));
      return t4.style && v6.style !== t4.style && (A3.style = y({}, t4.style, {}, v6.style)), A3.className = Array.prototype.concat(c3, d3, g3 !== d3 ? g3 : null, t4.className, v6.className).filter(Boolean).join(" "), A3.ref = S2, (0, import_react.createElement)(b2, A3);
    }(A2, e3, t3, I2);
  };
  ...
  "node_modules/react-animated-text-content/dist/react-animated-text-content.development.js"(exports, module) {
    (function(g2, f2) {
      ...
      var StyledWrapper = styled__default["default"].div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  @keyframes fragmentletter-", " {\n    0% {\n      opacity: 0;\n      visibility: hidden;\n      transform: translateX(", ")\n        translateY(", ")\n        scale(", ");\n    }\n    100% {\n      oapcity: 1;\n      visibility: visible;\n      transform: translateX(0) translateY(0) scale(1);\n    }\n  }\n\n  & > span {\n    display: inline-block;\n  }\n\n  & ", " {\n    text-decoration: inherit;\n    vertical-align: inherit;\n\n    animation: ", ";\n\n    animation-name: ", ";\n  }\n\n  ", "\n"], ["\n  @keyframes fragmentletter-", " {\n    0% {\n      opacity: 0;\n      visibility: hidden;\n      transform: translateX(", ")\n        translateY(", ")\n        scale(", ");\n    }\n    100% {\n      oapcity: 1;\n      visibility: visible;\n      transform: translateX(0) translateY(0) scale(1);\n    }\n  }\n\n  & > span {\n    display: inline-block;\n  }\n\n  & ", " {\n    text-decoration: inherit;\n    vertical-align: inherit;\n\n    animation: ", ";\n\n    animation-name: ", ";\n  }\n\n  ", "\n"])), function(_a) {
        ...
        var x2 = _a.animation.x;
        return x2 !== null && x2 !== void 0 ? x2 : 0;
      }, function(_a) {
        var y2 = _a.animation.y;
        return y2 !== null && y2 !== void 0 ? y2 : 0;
      }, function(_a) {
        ...
        for (var i2 = 0; i2 < count; i2 += 1) {
          styles += "".concat(AnimatedFragment, ":nth-of-type(").concat(i2 + 1, ") {\n            animation-delay: ").concat((interval || 0.04) * i2, "s;\n          }");
        }
...
export default require_react_animated_text_content();
...
react-animated-text-content/dist/react-animated-text-content.development.js:
  (*! *****************************************************************************
